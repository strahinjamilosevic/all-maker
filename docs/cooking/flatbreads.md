...
2. Put all ingredients into a bowl and take a sillicon, bendy spatula. 
   ...
   :::
3. Hold the bowl with one hand. Mix the ingredients with the spatula in your other hand.
4. Once the dough is homogenous, you are done.
   :::tip
...
1. Air-seal the bowl. You can:
   a. Use the plastic cooking wrap.
   b. Put a wet kitchen cloth over the bowl.
2. Keep the bowl warm. Either cover it or keep it somewhere warm to help the yeast do its work.
...
1. Uncover the bowl and let the air escape.
2. Put two sheets of baking paper on a flat surface.
   :::tip
   On my kitchen counter, I put one sheet straight on the baking tray and the second one next to it.
   :::
3. Hold the bowl with one hand and use the spatula to spill the whole dough on the baking paper.
   :::info
   The dough should be both oily and airy. The consistency should allow it to spill out of the bowl, but not be runny like for pancakes.
   :::
4. Oil up your hands a bit. The dough should have mostly flattened out by now.
5. Form between 8 an 16 buns of dough and spread them on the baking paper.
   :::tip
   I use the spatula for this as well. I separate chunks and place them on the baking paper. I make sure they are about 1 cm (up to half an inch) thick.
   :::
...
1. Preheat the oven to 200°C (about 400°F).
   :::tip
   Use the oven program that heats from both the top and the bottom. If you think your oven is not very good, feel free to preheat it to 220°C (about 430°F).
   :::
