...
description: The relationship between technical work and creative expression.
---
...
That's the whole thesis. I could stop here but I already wrote the title.
...
But it's also just capability. It's infrastructure that keeps the machine running. It doesn't tell you *why* it should run in the first place.
...
I write docs all day. I structure knowledge, design user journeys, and think in headings and pipeline optimizations. It's satisfying in the way that organizing a toolbox is satisfying—everything in its place, everything serving a function.
